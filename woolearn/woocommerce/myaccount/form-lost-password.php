<?php
   ...
   wc_print_notices(); ?>
<form method="post" class="page-account woocommerce-ResetPassword lost_reset_password">
   <div class="reset-password">
      <div class="col-md-8 block-center">
         ...
         <p class="col-md-8 pull-right">
            ...
            <input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_login" id="user_login" placeholder="پست الکترونیک" />
         </p>
